    ...
    <footer id="footer" className="bg-slate-950 text-slate-400 text-sm border-t border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs sm:text-sm">
              <li>
                <a href="#hero" className="hover:text-amber-400 transition-colors">{tFooter.navHome}</a>
              </li>
              <li>
                <a href="#fleet" className="hover:text-amber-400 transition-colors">{tFooter.navFleet}</a>
              </li>
              <li>
                <a href="#about" className="hover:text-amber-400 transition-colors">{tFooter.navAbout}</a>
              </li>
              <li>
                <a href="#booking" className="hover:text-amber-400 transition-colors">{tFooter.navBooking}</a>
              </li>
              <li>
                <a href="#branches" className="hover:text-amber-400 transition-colors">{tFooter.navBranches}</a>
              </li>
              <li>
                <a 
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-xs">
              <a
                href={`tel:${COMPANY_INFO.phoneRaw1}`}
                className="flex items-center justify-between gap-2 text-slate-300 hover:text-amber-400 transition-colors p-2.5 bg-slate-900 rounded-xl border border-slate-800"
                aria-label={`Call ${COMPANY_INFO.phone1}`}
              >
        ...
        <div className="mt-12 pt-8 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          ...
          <button
            onClick={scrollToTop}
            className="inline-flex items-center gap-1.5 bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-amber-400 px-3.5 py-2 rounded-xl border border-slate-800 transition-colors cursor-pointer"
